...
*******************************************************
	@begin
		...
		@param [src]
                The source  string
		@param [append]
                The string appended to source string
		@return
...
*******************************************************
	@begin
		@type fun
		@brief
			Copy src to dst, truncating or null-padding to
			always copy n bytes
		@detail
...
*******************************************************
	@begin
		...
		@detail
			No checking in this function,please
			MAKE SURE that the size of 'to'
			MUST be NO less than the size of 'from'
		@param [to]
                The target string
		@param [from]
                The source string
